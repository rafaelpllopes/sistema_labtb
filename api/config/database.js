...
const INSERT_DEFAULT_UNIDADES = [
    ...
    `INSERT INTO unidades (unidade, cnes) SELECT 'BOM SUCESSO DE ITARARÉ', '' WHERE NOT EXISTS (SELECT * FROM unidades WHERE unidade = 'BOM SUCESSO DE ITARARÉ' AND cnes = '')`,
    `INSERT INTO unidades (unidade, cnes) SELECT 'BURI', '' WHERE NOT EXISTS (SELECT * FROM unidades WHERE unidade = 'BURI' AND cnes = '')`,
    `INSERT INTO unidades (unidade, cnes) SELECT 'ITABERÁ', '' WHERE NOT EXISTS (SELECT * FROM unidades WHERE unidade = 'ITABERÁ' AND cnes = '')`,
    `INSERT INTO unidades (unidade, cnes) SELECT 'ITARARÈ', '' WHERE NOT EXISTS (SELECT * FROM unidades WHERE unidade = 'ITARARÈ' AND cnes = '')`,
    `INSERT INTO unidades (unidade, cnes) SELECT 'NOVA CAMPINA', '' WHERE NOT EXISTS (SELECT * FROM unidades WHERE unidade = 'NOVA CAMPINA' AND cnes = '')`,
    `INSERT INTO unidades (unidade, cnes) SELECT 'RIBEIRÃO BRANCO', '' WHERE NOT EXISTS (SELECT * FROM unidades WHERE unidade = 'RIBEIRÃO BRANCO' AND cnes = '')`,
    `INSERT INTO unidades (unidade, cnes) SELECT 'RIVERSUL', '' WHERE NOT EXISTS (SELECT * FROM unidades WHERE unidade = 'RIVERSUL' AND cnes = '')`,
